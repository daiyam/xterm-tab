...
if (config.addon) {
  ...
  bundleConfig = {
    ...
    alias: {
      ...
      "@daiyam/xterm-tab-addon-image": "./addons/addon-image/lib/addon-image.mjs",
      "@daiyam/xterm-tab-addon-progress": "./addons/addon-progress/lib/addon-progress.mjs",
      "@daiyam/xterm-tab-addon-search": "./addons/addon-search/lib/addon-search.mjs",
      "@daiyam/xterm-tab-addon-serialize": "./addons/addon-serialize/lib/addon-serialize.mjs",
      "@daiyam/xterm-tab-addon-web-fonts": "./addons/addon-web-fonts/lib/addon-web-fonts.mjs",
      "@daiyam/xterm-tab-addon-web-links": "./addons/addon-web-links/lib/addon-web-links.mjs",
      "@daiyam/xterm-tab-addon-webgl": "./addons/addon-webgl/lib/addon-webgl.mjs",
      "@daiyam/xterm-tab-addon-unicode11": "./addons/addon-unicode11/lib/addon-unicode11.mjs",
      "@daiyam/xterm-tab-addon-unicode-graphemes": "./addons/addon-unicode-graphemes/lib/addon-unicode-graphemes.mjs",
      ...
      "@daiyam/xterm-tab-addon-ligatures": "./addons/addon-ligatures/out-esbuild/LigaturesAddon",
    }
  }
  skipOut = true;
  skipOutTest = true;
