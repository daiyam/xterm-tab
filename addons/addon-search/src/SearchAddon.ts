...
import type { Terminal, IDisposable, ITerminalAddon, IDecoration } from '@daiyam/xterm-tab';
import type { SearchAddon as ISearchApi } from '@daiyam/xterm-tab-addon-search';
