...
import type { IDisposable, ITerminalAddon, Terminal } from '@daiyam/xterm-tab';
import { type IClipboardProvider, ClipboardSelectionType, type IBase64 } from '@daiyam/xterm-tab-addon-clipboard';
